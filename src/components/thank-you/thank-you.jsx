...
export const ThankYou = () => {
    return (
        <div className="text-center">
            ...
            <p className="lead">We hope your experience was awesome and we can’t wait to <strong>see you again soon</strong>.</p>
            <hr />
            <p className="lead">
                <StyledLink className="btn btn-lg" to="/">
                    <button type="button" className="btn btn-primary btn-lg">Continue to homepage</button>
                </StyledLink>
            </p>
        </div>
    )
